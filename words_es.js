// Hangmango Spanish word bank v=001
...
const WORD_BANK_ES = {
  ...
  ciencia: {
    ...
    medium: ['ENERGÍA', 'VOLCÁN', 'PLANETA', 'COMETA', 'ECLIPSE', 'GRAVEDAD', 'MOLÉCULA', 'PROTEÍNA', 'BACTERIA', 'OXÍGENO', 'CARBONO', 'NEUTRÓN', 'TSUNAMI', 'GALAXIA', 'PRESIÓN'],
    hard:   ['FOTOSÍNTESIS', 'ASTRONOMÍA', 'ATMÓSFERA', 'CROMOSOMA', 'ELECTRÓN', 'ECOSISTEMA', 'EVOLUCIÓN', 'METEORITO', 'MICROSCOPIO', 'ELECTRÓNICA', 'HIDRÓGENO', 'MAGNETISMO', 'GEOLOGÍA', 'TELESCOPIO', 'RADIACIÓN']
  },
  música: {
  ...
  geografía: {
    ...
    hard:   ['CORDILLERA', 'ARCHIPIÉLAGO', 'CONTINENTE', 'MERIDIANO', 'PRECIPICIO', 'SUBTRÓPICO', 'HEMISFERIO', 'ALTIPLANO', 'PROMONTORIO', 'HIDROGRAFÍA', 'ESTRATOSFERA', 'TERREMOTO', 'LITOLOGÍA', 'CARTOGRAFÍA', 'TOPOGRAFÍA']
  }
};
